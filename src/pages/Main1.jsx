      ...
      <main className="max-w-xl mx-auto px-6 py-12 relative z-10">
        ...
        <div className="relative group p-1 bg-cyan-500/10 border border-cyan-500/20 rounded-2xl">
          <button 
            ...
            className="relative w-full overflow-hidden py-8 bg-[#0a0a0a] border border-cyan-400/50 rounded-xl group transition-all active:scale-95"
          >
            ...
            <div className="relative z-10 flex flex-col items-center gap-2">
              <div className="flex items-center gap-3 text-3xl font-black italic tracking-tighter text-cyan-400 uppercase">
        ...
        {/* Proof Section with Data Overlay */}
